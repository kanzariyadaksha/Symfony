<?php session_start();
$domain = "1099taxhelp.net";
$website = "http://www.1099taxhelp.net/";
$companyName = "1099 Tax Help";
$termsLink = "";
$email = "support@1099taxhelp.net";
$contactPhone = "";
$contactAddress = "15333 Culver Dr.
Suite 340-244
Irvine, CA 92604";
$MainComapny = "Forward Leap Marketing";
?>
<!doctype html>
<html class="no-js" lang="en">
  <head>
    ...
    <script src="/includes/js/d.js" type="text/javascript"></script>
  ...
  <body class="terms">
     <nav class="navbar navbar-expand-lg navbar-dark bg-primary justify-content-center justify-content-sm-between fixed-top">
      ...
      <div id="form-container" class="container-fluid">
        <div id="privacy">
            <h1><?php echo $domain;?> Online Terms of Use</h1>

            <p>Last updated: May 1, 2018</p>
            <h4  class="title">AGREEMENT BETWEEN USER AND <?php echo $domain;?>.</h4>

            <p>The “Company” consists of Forward Leap Marketing, Inc. all related companies, its parents, subsidiaries, publisher sites, respective directors, officers, shareholders, employees, affiliates, assigns, consultants and agents.</p>

            <p>The “Website” consists of <?php echo $domain;?>, all websites owned and operated by Forward Leap Marketing and its subsidiaries, related companies, publishers, affiliates, assigns, and agents.</p>

            <p>PLEASE READ THESE TERMS CAREFULLY BEFORE USING THE WEBSITE. YOUR ACCESS AND/OR USE OF THE WEBSITE CONFIRMS YOUR UNCONDITIONAL ACCEPTANCE OF THE FOLLOWING TERMS. IF YOU DO NOT FULLY ACCEPT THESE TERMS, DO NOT USE OR ACCESS THE WEBSITE.</p>

            <p>Notice Regarding Dispute Resolution: These Terms contain provisions that govern how claims you and the Company may have against each other are resolved (see the Section on "Arbitration" below), including a class action waiver and an obligation to arbitrate disputes, which will, subject to limited exceptions, require you to submit claims you have against us to binding arbitration, unless you opt-out in accordance with the Section on "Arbitration," below.</p>

            <p>
                <?php echo $domain;?> provides our website visitors with access to its content, resources, and tools for communication, public forums, commerce platforms, and other services through its network of websites at <?php echo $domain;?> (the "Website"). <?php echo $domain;?> provides its service to the user and all visitors, subject to the following Terms of Use.
            </p>

            <p>The Website is comprised of various Web pages owned and operated by <?php echo $MainComapny ;?> and its subsidiaries (together, "Company"). Company provides you with access to a variety of resources, including consumer news, information, consumer comments and complaints, self-help tools and directories of resources provided by other parties (collectively "Services"). All such Services are subject to the Terms of Use. Company reserves the right to cancel your access to the Services for violation of these Terms of Use, in its sole discretion.</p>

            <p>The Website is offered to you conditioned on your acceptance without modification of the terms, conditions, and notices contained herein. Your use of the Website constitutes your agreement to all such terms, conditions, and notices.</p>
            <p>This Website is not directed towards residents of the European Union. Under no circumstances are residents of the European Union permitted to visit our Sites and share their personal information.</p>

            <h5 class="title">Conditions of Use</h5>
            
            <p>THESE TERMS AND CONDITIONS OF USE APPLY TO ALL MATERIALS, ONLINE COMMUNICATIONS AND OTHER INFORMATION AND MATERIALS THAT ARE OR BECOME AVAILABLE ON OR THROUGH THE WEBSITE (COLLECTIVELY, THE "MATERIAL"). PLEASE READ THESE TERMS AND CONDITIONS OF USE CAREFULLY. BY ACCESSING THE WEBSITE YOU SPECIFICALLY ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS AND CONDITIONS OF USE AND YOU SPECIFICALLY AGREE, WITHOUT LIMITATION OR QUALIFICATION, TO EACH OF THE PROVISIONS CONTAINED HEREIN. THESE TERMS AND CONDITIONS MAY BE REVISED AT ANY TIME BY UPDATING THIS POSTING. YOU ARE BOUND BY ANY SUCH REVISIONS AND SHOULD THEREFORE PERIODICALLY VISIT THIS PAGE TO REVIEW THE THEN CURRENT TERMS AND CONDITIONS TO WHICH YOU ARE BOUND.</p>
            
            <p>THESE TERMS AND CONDITIONS OF USE FORM A LEGALLY BINDING AGREEMENT. IF YOU DO NOT AGREE TO ANY OR ALL OF THE PROVISIONS FOUND IN THESE TERMS AND CONDITIONS OF USE, PLEASE IMMEDIATELY EXIT THE WEBSITE. WE RESERVE THE RIGHT TO TERMINATE YOUR USE OF OR ACCESS TO THE WEBSITE OR YOUR ACCOUNT AT ANY TIME FOR ANY REASON, INCLUDING, WITHOUT LIMITATION, IF WE LEARN THAT YOU HAVE VIOLATED THESE TERMS AND CONDITIONS OF USE.</p>

            <h5 class="title">Disclaimer of Warranties</h5>
            
            <p>YOU EXPRESSLY AGREE THAT USE OF THE WEBSITE IS AT YOUR SOLE RISK. THE MATERIAL PROVIDED ON THE WEBSITE IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. TO THE FULLEST EXTENT PERMITTED BY LAW, COMPANY DISCLAIMS ALL WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING WITHOUT LIMITATION, WARRANTIES OF TITLE, NONINFRINGEMENT, OR IMPLIED WARRANTIES OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE WITH RESPECT TO THE WEBSITE, ANY USE OF THE WEBSITE AND ANY WEBSITE TO WHICH THE WEBSITE IS LINKED. COMPANY DOES NOT WARRANT THAT THE MATERIAL ON THE WEBSITE IS COMPLETE OR ACCURATE, THAT USE OF THIS WEBSITE WILL BE UNINTERRUPTED OR ERROR FREE, OR THAT THIS WEBSITE OR SERVER OR ANY MATERIAL ON THIS WEBSITE IS FREE OF DISABLING DEVICES (AS HEREINAFTER DEFINED).</p>
            
            <p>YOU UNDERSTAND AND AGREE THAT ANY MATERIAL DOWNLOADED OR OTHERWISE OBTAINED THROUGH THE WEBSITE IS DONE AT YOUR OWN DISCRETION AND RISK AND THAT YOU WILL BE SOLELY RESPONSIBLE FOR ANY DAMAGE TO YOUR COMPUTER SERVICES OR LOSS OF DATA THAT RESULTS FROM THE DOWNLOAD OF SUCH MATERIAL.</p>
            
            <p>A "DISABLING DEVICE" IS DEFINED AS ANY SOFTWARE, DOCUMENT, MESSAGE OR OTHER MATERIAL WHICH CONTAINS A COMPUTER VIRUS, WORM, TROJAN HORSE, TIME-BOMB OR OTHER HARMFUL DEVICE WHICH MAY ERASE, SCRAMBLE, LOCK OR DISABLE COMPUTER SOFTWARE OR EQUIPMENT OR MAY PREVENT USERS FROM USING A WEBSITE OR ANY OTHER ITEM OF HARDWARE OR SOFTWARE.</p>
            
            <h5 class="title">Limitations on Authority</h5>

            <p>WHILE COMPANY USES REASONABLE EFFORTS TO INCLUDE ACCURATE AND UP-TO-DATE INFORMATION ON THE WEBSITE, ERRORS OR OMISSIONS SOMETIMES OCCUR.</p>

            <p>YOU UNDERSTAND THAT TO THE EXTENT PERMITTED UNDER APPLICABLE LAW, UNDER NO CIRCUMSTANCES SHALL COMPANY, OR ITS OFFICERS, EMPLOYEES, DIRECTORS, MANAGERS, PARENTS, SUBSIDIARIES, AFFILIATES, AGENTS OR LICENSORS, BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE OR CONSEQUENTIAL DAMAGES THAT MAY RESULT FROM THE USE OR INABILITY TO USE THIS WEBSITE, OR THE MATERIAL, INCLUDING WITHOUT LIMITATION, USE OF OR RELIANCE ON THE MATERIAL, INTERRUPTIONS, ERRORS, DEFECTS, MISTAKES, OMISSIONS, DELETION OF FILES, DISABLING DEVICES, DELAYS IN OPERATION OR TRANSMISSION, NONDELIVERY OF INFORMATION, DISCLOSURE OF COMMUNICATIONS, OR ANY OTHER FAILURE OF PERFORMANCE, DAMAGES FOR LOSS OF REVENUES, PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES ARISING OUT OF OR RELATED TO YOUR USE OF THE WEBSITE, REGARDLESS OF WHETHER SUCH DAMAGES ARE BASED ON CONTRACT, TORT (INCLUDING NEGLIGENCE AND STRICT LIABILITY), WARRANTY, STATUTE OR OTHERWISE. IF YOU ARE DISSATISFIED WITH ANY PORTION OF THE WEBSITE, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE USE OF THE WEBSITE.</p>
            
            <p>YOU (AND NOT COMPANY OR ITS PARENTS OR AFFILIATES) SOLELY ASSUME THE ENTIRE COST OF ALL NECESSARY SERVICING, REPAIR OR CORRECTION RELATED TO ANY DAMAGE, HARM, INJURY OR MALFUNCTION ASSOCIATED WITH YOUR USE OF THE WEBSITE AND/OR ITS CONTENTS.</p>

            <h5 class="title">Disputes</h5>
            
           

            <p>Initial Dispute Resolution. The Company is available by email at <a href='mailto:<?php echo $email;?>'><?php echo $email;?></a> address any concerns you may have regarding your use of the Website. Most concerns may be quickly resolved in this manner. The parties shall use their best efforts to settle any dispute, claim, question, or disagreement directly through consultation and good faith negotiations, which shall be a precondition to either party initiating a lawsuit or arbitration. Any matter and/or dispute relating in any way to your visit to or interaction with the Website, including compliance with these Terms, which is not so resolved shall be submitted to binding confidential arbitration as provided in the Section entitled Arbitration below.</p>
           ...
           <h5 class="title">Miscellaneous</h5>
            ...
            <ul>
                ...
                <li>a statement by you that you have a good faith belief that the use of the Content identified in your written notification in the manner complained of is not authorized by you or the copyright owner, its agent or the law; and a statement by you that the information in your written notification is accurate and that, under penalty of perjury, you are the copyright owner or authorized to act on behalf of the copyright owner.</li>               
            </ul>
            
            <p>Company’s designated agent for the written notification of claims of copyright infringement can be contacted at the following address:</p>
            
            <div>
                <p style="padding-left: 40px !important;">Designated Agent – Copyright Infringement Claims <br>
                Support.com<br>
                c/o Greenspoon Marder, Attention: Robby H. Birnbaum, Esq.<br>
                100 West Cypress Creek Road, Suite 700<br>
                Fort Lauderdale, FL 33309<br>
                Phone: (954) 343 6959<br>
                Email: Robby.Birnbaum@gmlaw.com 
                </p>
            </div>
            
            <h5 class="title">Indemnification</h5>
            <p>You agree to indemnify, defend and hold harmless Company, its parents, subsidiaries, affiliates, officers, directors, managers and other partners, employees, consultants and agents, from and against any and all claims, liabilities, damages, losses, costs, expenses, fees (including reasonable attorneys’ fees and court costs) resulting or arising from (1) any information you (or anyone accessing the your account using your password) submit through the Website, (2) your violation of these Terms and Conditions of Use or applicable law, (3) your (or anyone using your account/computer/device) violation of any rights of any other person or entity, or (4) any Disabling Device or other similar harmful or deleterious programming routines input by you into the Website.</p>
            
            <h5 class="title">Exclusions and Limitations</h5>
      ...
      <div class="container-fluid">
        <footer>
            <p><a href="/terms.php">Terms and Conditions</a>  |  <a href="/privacy-policy.php">Privacy Policy</a></p>
        </footer> 
      </div>
