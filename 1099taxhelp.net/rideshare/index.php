...
if(!isset($_REQUEST['ClientGuid']) && !isset($_REQUEST['VendorGuid']) && !isset($_REQUEST['LocationCode']) ){
    ...
    $url = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/rideshare/?' . http_build_query($data);
    header("Location: $url");
    exit;
}
			...
			<section class="taxhelp-for-drivers">
				<div class="container">
					<div class="row justify-content-between align-items-end">
						<div class="col-lg-7 text-left text-sm-center text-lg-left mb-lg-0 mb-5 order-2 order-sm-1">
							<?php if(isset($_REQUEST['error_post'])){?>
								<p class="error">An error occurred. Please try again.</p>
							<?php }?>
							<h1><span>There may be help for</span>Uber/Lyft Drivers with Tax Debt</h1>
							<h3>Do you earn money from what many consider a <span>side gig</span>?</h3>
							<p>57 million Americans do. From Uber, Lyft or GrubHub drivers to freelance graphic designers, web developers, or
							freelance writers, many self-employed Americans could be facing a higher-than-expected tax bill this year.</p>
						...
						<div class="col-lg-5 order-1 order-sm-2">
							<form class="row tax-form mx-auto" id="ckm_form" action="/process/" name ="ckm_form" method="post">
								<?php echo $formFields; ?>
								...
								<section class="step step-1 active form-group col-12">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="selectbox">
												<select class="form-control" id="tax_debt" name="tax_debt">
								...
								<section class="step step-3 form-group col-12">
									<label class="form-title d-block d-sm-none">What's your name? </label>
									<div class="row">
								...
								<section class="step step-4 form-group col-12 col-sm-10">
									<label class="form-title d-block d-sm-none">What is your email address?</label>
								...
								<section class="step step-5 form-group col-12 col-sm-6">
									<label class="form-title d-block d-sm-none">What's your phone number? </label>
								...
								<div class="col-12 col-sm-12 d-block d-sm-none text-center">
									<button type="button" class="btn btn-primary submit next hide-submit" data-currentstep="1"><span>Continue</span></button>
									<button type="submit" style="display: none;" class="btn btn-primary submit next show-submit" data-currentstep="1"><span>Submit</span></button>
								</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="info-text">
								If you are an independent contractor or a freelancer, you should receive a 1099 form every January. This paperwork is
								similar to a W-2 form sent by employers – it shows how much money you made in the tax year. Unlike W-2s employees,
								though, 1099 contractors do not get any taxes take out. No social security. No unemployment. No federal taxes. But you
								still have to pay into these funds through something called Self-employment tax. And that means if you’re a driver for
								Uber or Lyft – or any other type of 1099 contractor – you might owe the IRS more than you expected.
							</div>
						</div>
				...
				<div class="container">
					<div class="row justify-content-lg-end">
						<div class="col-lg-6">
							...
							<div class="info-text">
								<p>It’s not unusual for independent contractors like Uber and Lyft drivers to owe thousands in tax debt on April 15th. And
									most workers in the gig economy don’t have savings stashed away to pay their taxes. In fact, 46% of Americans live
									paycheck-to-paycheck. So, if you didn’t set aside 30% of your pay from every gig, it’s understandable. You needed that
								money to live. But now you’re faced with un unexpected tax bill.</p>

								<p>Fortunately, self-employed individuals may have multiple tax deductions they didn’t know about. A professional tax firm
									can help you find those deductions to reduce what you owe in taxes. Working with a professional tax firm to file your
									1099 taxes can help you reduce your tax debt with appropriate, legal tax deductions that won’t raise red flags with the
									IRS.You can reduce the amount you own without worrying about an audit. Take action quickly, because you may realize your
								situation isn’t as bad as you first thought.</p>
							</div>
						</div>
						<div class="col-lg-6 d-none d-sm-block d-lg-none">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="info-text">
								There are options for 1099 Contractors facing tax debt. Tax experts can buy you more time. Tax professionals can help
								you file the paperwork for an offer-in-compromise, a partial pay installment agreement, or even an extension. Any of
								these actions can help you avoid additional late fees and penalties and help prevent levies or liens on your property.
								Don’t let your debt pile up. Let 1099 Tax Help assist you to find a tax expert that can alleviate your tax challenges
								in the gig economy.
							</div>
						</div>
						<div class="col-lg-6 d-none d-sm-block d-lg-none">
			...
			<section class="container-fluid footer">
				<div class="container">
					...
					<div class="footer-text">
						<p>1099 Tax Help is a matching service for various services. By calling and/or providing your personal information, you
							agree that your information may be collected and transferred to a company that may be able to assist you. Your personal
							details are important to us. Our partners’ clients’ results may vary based on ability to save funds and completion of
							all program terms. Not all of our partners’ clients’ are able to complete their program for various reasons, including
						their ability to save sufficient funds.</p>
						<p>Our partners’ estimates are based on prior results, which will vary depending on your specific circumstances. Our
							partner does not guarantee that your debts will be resolved for a specific amount or percentage or within a specific
							period of time. Our partners do not assume your debts, make monthly payments to creditors or provide tax, bankruptcy,
							accounting or legal advice or credit repair services. Our partners’ service is not available in all states and their
							fees may vary from state to state. Please contact a tax professional to discuss potential tax consequences of less than
							full balance debt resolution. Depending on the product or services offered, you may be able to obtain this service on
							your own without the help of one of our 3rd party members of our network. Read and understand all program materials
						...
						<p>Legal - 1099.net is a privately owned website that is not owned or operated by any state, federal government agency or associated with Lyft or Uber.</p>
					</div>
					<div class="copyright">
					...
					if (window.innerWidth <= 576) {
						...
						$('.next').unbind().click(function () {
							...
							if(isValid) {
								...
								if (pos==3) {
									// $('.hide_emailCompailance').show();
									// $('.hide_terms').show();
									$('.tax-form').addClass('form-details-active');
								}else{
									$('.tax-form').removeClass('form-details-active');
								}
